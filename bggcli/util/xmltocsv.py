...
class XmlToCsv:
    ...
    def convert_item(el):
        ...
        return {
            ...
            'numplays': XmlToCsv._to_int(el.find('numplays').text),
            ...
            'collid': el.attrib.get('collid'),
            'baverage': XmlToCsv._zero_if_na(XmlToCsv._wrap(el.find('stats/rating/bayesaverage')).get('value')),
            'average': XmlToCsv._zero_if_na(XmlToCsv._wrap(el.find('stats/rating/average')).get('value')),
            'numowned': XmlToCsv._to_int(XmlToCsv._wrap(el.find('stats')).get('numowned')),
            'objecttype': el.attrib.get('objecttype'),
            'minplayers': XmlToCsv._to_int(XmlToCsv._wrap(el.find('stats')).get('minplayers')),
            'maxplayers': XmlToCsv._to_int(XmlToCsv._wrap(el.find('stats')).get('maxplayers')),
            'playingtime': XmlToCsv._to_int(XmlToCsv._wrap(el.find('stats')).get('playingtime')),
            'maxplaytime': XmlToCsv._to_int(XmlToCsv._wrap(el.find('stats')).get('maxplaytime')),
            'minplaytime': XmlToCsv._to_int(XmlToCsv._wrap(el.find('stats')).get('minplaytime')),
#            'yearpublished': XmlToCsv._to_str(el.find('yearpublished').text),
            'yearpublished': XmlToCsv._to_str(XmlToCsv._wrap(el.find('yearpublished')).text),
            ...
            'barcode': XmlToCsv._to_str(XmlToCsv._wrap(version_el.find('barcode')).text),
